...
const questions = [
  { q: 'Which company created GPT-4?', options: ['Google', 'OpenAI', 'Meta', 'Anthropic'], answer: 1 },
  { q: 'What does MoE stand for in the context of LLM architectures?', options: ['Model of Embeddings', 'Mixture of Experts', 'Mode of Execution', 'Multiple Output Encoding'], answer: 1 },
  { q: 'Which company developed the Llama family of models?', options: ['OpenAI', 'Google DeepMind', 'Meta', 'Microsoft'], answer: 2 },
  { q: 'What is Claude\'s primary differentiating approach to AI development?', options: ['Largest parameter count', 'Constitutional AI and safety focus', 'Fastest inference speed', 'Lowest training cost'], answer: 1 },
  { q: 'Which of the following models is open-source?', options: ['GPT-4', 'Claude 3', 'Gemini Ultra', 'Llama 3'], answer: 3 },
]
